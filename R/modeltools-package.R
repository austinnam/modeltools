...
#' }
#' \subsection{Tools}{
#'   \code{\link{fieller}} returns Fieller's confidence interval for a ratio of two vectors. \cr\cr
#'   \code{\link{confint.vector}} returns a confidence interval of a vector using a normal distribution. 
#' }
#' 
#' @docType package
#' @name modeltools
